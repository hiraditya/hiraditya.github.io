...
*Disclaimer: Researched and drafted with AI assistance (Gemini 3.1 Pro, Claude Opus 4.8). Direction, technical judgment, and final edits are mine; every claim is traceable to the sources cited above. This post is for informational purposes only and does not constitute legal advice; consult a qualified attorney on intellectual property, licensing, or jurisdictional matters.*
